/*
  ...
  1. Changes
    - Use DO blocks with conditional checks to create policies only if they don't exist
    - Ensures policies are created only if they don't already exist
    - Avoids syntax errors with IF NOT EXISTS which is not supported for policies
*/
