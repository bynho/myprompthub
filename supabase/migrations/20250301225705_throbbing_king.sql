/*
  # Reset and Improve Database Schema

  1. Schema Changes
    - Drop existing tables if they exist
    - Create new tables with improved structure:
      - `prompts` with auto-incrementing numeric IDs
      - `prompt_translations` with references to prompts
      - `prompt_ratings` for user ratings
